...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                    options=[
                                        ...
                                        {'label': 'Cape Canavral - CCAFS LC-40', 'value': 'CCAFS LC-40'},
                                        {'label': 'Cape Canavral CCAFS SLC-40', 'value': 'CCAFS SLC-40'}, 
                                        {'label': 'Kennedy Space Center KSC LC-39A', 'value': 'KSC LC-39A'}, 
                                        {'label': 'Vanderberg VAFB SLC-4E', 'value': 'VAFB SLC-4E'}
                                ], 
...
def get_scatter_chart(selected_site, payload_range):
    ...
    fig = px.scatter(df_mask, x='Payload Mass (kg)', y= 'class', color='Booster Version Category', title = f"Correlation between Payload & Success for {selected_site}")
    return fig
